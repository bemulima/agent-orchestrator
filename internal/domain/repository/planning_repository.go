...
type PlanningRepository interface {
	...
	AddPlanComment(context.Context, string, string, string) (domain.PlanBundle, error)
	SubmitPlan(context.Context, string, string, string) (domain.PlanBundle, error)
	ApprovePlan(context.Context, string, string, string, string) (domain.PlanBundle, error)
